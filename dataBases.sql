...
-- Listage des données de la table universities_api.addresses : ~17 rows (environ)
/*!40000 ALTER TABLE `addresses` DISABLE KEYS */;
INSERT INTO `addresses` (`id`, `mail`, `phone`, `street`, `url`) VALUES
	(1, 'infos.iaec@ieactogo.com', '+22822202092', 'Bd De la Kara, Derrière l’ambassade du Sénégal, Tokoin-Doumassesse', 'https://iaectogo.com/'),
	(2, 'info.eamau@eamau.org', '+228 22 21 62 53', 'BP 2067, 442, rue des Balises, Tokoin Doumasséssé', 'eamau.org'),
	(3, 'scolarite@ucao-uut.tg', '+228 96 80 31 67', 'Sanguera et Saint Joseph', 'https://ucao-uut.tg/'),
	(4, NULL, '93 08 80 80', 'BP 9141 Avenue Mobutu Sese Seko', NULL),
	(5, 'esatogo@yahoo.fr', '96 33 02 08 / 90 89 45 70', '689, rue Djablé sis au quartier super-Taco, derrière la BTCI annexe', 'https://www.esatogo.com/'),
	(6, 'hello@esiba.tg/infos@esiba.tg', '22 51 17 87', '01 BP 3518 Rue de la gare routière d\'Agbalépédogan prolongée vers Agoènyivé Assiyéyé', 'https://www.esiba.tg/'),
	(7, 'contact@esig.tg', '+ 228 22 71 17 17', '11 BP 149 Bvd de l\'Oti, face Eglise Catholique Maria Goretti de Bè-Kpota', 'https://esig.tg/'),
	(8, 'formatec03@yahoo.fr/formatec003@gmail.com/formatec03@formatec.tg', '(+228) 90 03 84 16', 'A 500m de la Cour d’Appel de Lomé Agoè Cacavéli – BP 20436 Lomé', 'http://formatec.tg/'),
	(9, 'esam@esamecole.fr', '(+228) 22 21 16 16', 'Avenue Nicolas Grunitzky, près de l\'Hôtel de ville de Lomé Quartier administratif - Centre ville - BP 3002', 'http://www.esamecole.fr/'),
	(10, 'info@iheris.org', '+228 79502661', 'Agoe Nyive, dellere le ceg Agoe Centre, a droite du Carrefour Blue, 04 BP 773 Lome 04 TOGO', 'https://iheris.org/'),
	(11, 'http://jumau-ita.org/', '22 51 02 75', 'Avenue Pya à côté dEcobank Totsi, en face de la pharmacie Nation. 01BP 1514 Lomé 01', 'http://jumau-ita.org/'),
	(12, 'esagnde@esagnde.org', '+228  22 21 68 58', '52 Boulevard des armées CESAL à Tokoin Séminaire/Avepozo se trouve à CEDIF derrière l\'Eglise Catholique St Joseph d\'Avepozo', 'https://esagnde.org/index.php/lecole/'),
	(13, 'esgis.togo@esgis.org', '22 25 12 93', '8, Rue Agnes GABA Kodjoviakope', 'https://www.esgis.org/fr/'),
	(14, 'usttg@yahoo.fr', '(00 228) 91 38 66 04', 'Quartier de Noukafou Boulevard Jean-Paul II', 'http://rusta-usttg.org/index.html'),
	(15, 'contact@ifordd.org', '+228 92 19 01 59', 'Rue 11HDN,Lomé TOGO', 'https://ifordd.org/'),
	(16, 'info@univ-kara.tg', '+228 26 61 02 85/+228 26 61 02 56', 'Route de l’ex ENI, au sud-est Kara, à 800 m environ de la Nationale N°1., 43 Lama, Kara, Togo', 'https://univ-kara.tg/'),
	(17, 'communication_ul@univ-lome.tg', '(+228) 22 21 35 00/(+228) 22 51 30 25', 'Boulevard Gnassingbé Eyadema 01BP1515 Lomé', 'https://univ-lome.tg/');
/*!40000 ALTER TABLE `addresses` ENABLE KEYS */;

-- Listage des données de la table universities_api.countries : ~241 rows (environ)
/*!40000 ALTER TABLE `countries` DISABLE KEYS */;
INSERT INTO `countries` (`id`, `code`, `alpha2`, `alpha3`, `name_en_GB`, `name_fr_FR`, `name_en`, `name_fr`) VALUES
...
-- Listage des données de la table universities_api.universities : ~0 rows (environ)
